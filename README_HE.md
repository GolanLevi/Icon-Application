...
<p align="center">
  <strong>צפייה ברשימת הסניפים, נתוני התפוסה בזמן אמת, אפשרויות החיוג, המועדפים, התמצאות מהירה במפה, איתור סניפים קרובים ובדיקת זמינות:</strong><br><br>
  <img src="icon_photo1.jpeg" width="70%" />
</p>

<p align="center">
  <strong>מסך התחברות, אימות לסלולר, אפשרויות התחברות שונות:</strong><br><br>
